...
R:r      - pulse Ratio:  (length of square pulse)
        ...
        F:s:d:h   - Frequency Sweep (only for channel 1)
                        Don't forget to put one in every instrument that uses
                        channel 1 as it is not reset when an instrument starts,
                        another instrument or sound fx could have changed it.
